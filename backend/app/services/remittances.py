...
CORRIDORS = {
    ...
    "GT": {
        "name": {"en": "Guatemala", "es": "Guatemala"},
        "currency": "GTQ",
        "delivery_methods": ["BANK", "CASH"],
        "typical_rate": 7.82,
    },
    "HN": {
        "name": {"en": "Honduras", "es": "Honduras"},
        "currency": "HNL",
        "delivery_methods": ["BANK", "CASH"],
        "typical_rate": 24.75,
    },
    ...
    "SV": {
        "name": {"en": "El Salvador", "es": "El Salvador"},
        "currency": "USD",
...
DELIVERY_METHODS = {
    "BANK": {
        "name": {"en": "Bank Deposit", "es": "Depósito Bancario"},
        "delivery_time": {"en": "Within 24 hours", "es": "En 24 horas"},
        "delivery_hours": 24,
    },
    "CASH": {
        "name": {"en": "Cash Pickup", "es": "Retiro en Efectivo"},
        "delivery_time": {"en": "Within 1 hour", "es": "En 1 hora"},
        "delivery_hours": 1,
    ...
    "DEBIT": {
        ...
        "delivery_time": {"en": "Within 30 minutes", "es": "En 30 minutos"},
        "delivery_hours": 0.5,
    },
    "WALLET": {
        "name": {"en": "Digital Wallet", "es": "Billetera Digital"},
        "delivery_time": {"en": "Instant", "es": "Instantáneo"},
        "delivery_hours": 0,
    },
}
...
KYC_LIMITS = {
    "KYC_LITE": {
        "display_name": {"en": "Basic", "es": "Básico"},
        "per_transaction": 500,
        "daily": 500,
        "monthly": 1000,
        "semiannual": 3000,
    ...
    "SENDER_KYC_L2": {
        "display_name": {"en": "ID Verified", "es": "ID Verificado"},
    ...
    "SENDER_KYC_L3": {
        "display_name": {"en": "Fully Verified", "es": "Completamente Verificado"},
...
# Transfer states
TRANSFER_STATES = {
    "CREATED": {"cancellable": True, "display": {"en": "Created", "es": "Creado"}},
    "PROCESSING": {"cancellable": True, "display": {"en": "Processing", "es": "Procesando"}},
    "IN_PROGRESS": {"cancellable": False, "display": {"en": "In Progress", "es": "En Progreso"}},
    "COMPLETED": {"cancellable": False, "display": {"en": "Completed", "es": "Completado"}},
    "FAILED": {"cancellable": False, "display": {"en": "Failed", "es": "Fallido"}},
    "CANCELLED": {"cancellable": False, "display": {"en": "Cancelled", "es": "Cancelado"}},
}
...
class MockRemittancesService:
    ...
    def _get_localized(self, obj: dict, default: str = "") -> str:
        """Get localized string from dict."""
        if isinstance(obj, dict):
            return obj.get(self.language, obj.get("es", obj.get("en", default)))
        return str(obj)
    ...
    def get_corridors(self, user_id: Optional[str] = None) -> dict:
        ...
        for code, config in CORRIDORS.items():
            corridors.append({
                "country_code": code,
                "country_name": self._get_localized(config["name"]),
    ...
    def create_quote(
        ...
        eta = self._get_localized(delivery_config.get("delivery_time", {"es": "24 horas"}))
    ...
    def list_recipients(
        ...
        formatted = []
        for r in recipients:
            country_name = self._get_localized(CORRIDORS.get(r["country"], {}).get("name", {}))
            default_method = next(
    ...
    def get_recipient(
        ...
        return {
            ...
            "country_name": self._get_localized(country_config.get("name", {})),
    ...
    def add_recipient(
        ...
        return {
            ...
            "name": display_name,
            "country": country,
            "country_name": self._get_localized(corridor["name"]),
    ...
    def get_delivery_methods(
        ...
        for method_type in corridor["delivery_methods"]:
            ...
            method = {
                "type": method_type,
                "name": self._get_localized(config.get("name", {})),
                "delivery_time": self._get_localized(config.get("delivery_time", {})),
    ...
    def get_user_limits(
        ...
        return {
            "kyc_level": kyc_level,
            "kyc_level_name": self._get_localized(limits_config["display_name"]),
            "limits": {
    ...
    def get_transfer_status(
        ...
        return {
            ...
            "status_display": self._get_localized(status_config.get("display", {})),
